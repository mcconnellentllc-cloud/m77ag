...
async function seedDefaultEntities() {
  const defaults = [
    ...
    { slug: 'cocorn', name: 'Colorado Corn / CCGA', color: '#eab308', icon: 'Sprout', description: 'Board & association work', expenseCategories: ['travel', 'events', 'meetings', 'association dues', 'other'] },
