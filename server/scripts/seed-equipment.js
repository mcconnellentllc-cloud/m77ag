...
const equipmentData = [
  ...
  // Titled Vehicles
  {
    ...
    notes: 'Unit #53, License: 225YOO, Owner: Personal, Insured: Yes',
    forSale: false,
    saleStatus: 'not-for-sale'
  },
  {
  ...
  {
    title: "2002 MacDon 973D 36' Draper Head",
    subtitle: '36\' Draper Head',
    category: 'Harvest Equipment',
    year: 2002,
    make: 'MacDon',
    model: '973D',
    description: "36' Draper Head",
    purchasePrice: 43000,
    currentValue: 30000,
    purchaseDate: new Date('2009-02-01'),
    notes: 'Unit #303, Owner: M77 AG, Insured: Yes',
    forSale: false,
    saleStatus: 'not-for-sale'
  },
  {
    title: '2012 Drago 12 Row Corn Head',
    ...
    currentValue: 25000,
    purchaseDate: new Date('2012-07-01'),
  ...
  },
  {
    ...
    purchaseDate: new Date('2014-09-01'),
