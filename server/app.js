// app.js - Authentication server with MongoDB Atlas
...
// MongoDB Atlas connection string - with correct cluster identifier
const ATLAS_URI = "mongodb+srv://m77ag:300Winmag!@cluster0.vder1su.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
.catch(err => {
  ...
  console.log('Continuing without database connection - static site will still work');
});
...
// Serve index.html for client-side routing - simplest form to avoid path-to-regexp issues
