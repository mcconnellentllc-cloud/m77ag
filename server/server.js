...
// REMOVED: Specific handlers for account pages
// app.get('/account/login', (req, res) => {...});
// app.get('/account/register', (req, res) => {...});

// KEEP this redirect for /account route
app.get('/account', (req, res) => {
  res.redirect('/account/login.html'); // Note: added .html extension
});

// Simple route for admin dashboard
